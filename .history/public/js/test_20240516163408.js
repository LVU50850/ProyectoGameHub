...
function showGames(){
    ...
    .then(data => {
        console.log('Juegos recomendados guardados en la base de datos:', data);
    })
    .catch(error => {
        console.error('Error al guardar juegos recomendados:', error);
    });
}
