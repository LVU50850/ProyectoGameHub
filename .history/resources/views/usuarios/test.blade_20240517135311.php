    ...
    <div class="quiz-container">
        ...
        <div class="not-played-questions hidden">
            ...
            <div class="question">
                ...
                <div class="answers">
                    <label><input type="radio" name="answer11" class = "respuesta1"> Menos de 1 hora</label><br>
                    <label><input type="radio" name="answer11" class = "respuesta2"> 1-3 Horas</label><br>
                    <label><input type="radio" name="answer11" class = "respuesta3"> 3-5 Horas </label><br>
                    <label><input type="radio" name="answer11" class = "respuesta4"> Más de 5 horas</label><br>
                </div>
            </div>
            <div class = "question">
