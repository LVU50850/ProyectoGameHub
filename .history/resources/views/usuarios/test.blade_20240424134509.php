...
<body>
    <div class="quiz-container">
        ...
        <div class="question hidden" id="not_played_questions1">
        ...
        <div class="question hidden" id="not_played_questions2">
            ...
            <div class="answers">
                ...
                <label><input type="radio" name="answer2" class="answer2"> Practicar deportes o actividades físicas</label><br>
