        ...
        <div class="played-questions hidden">
            ...
            <div class="question">
                ...
                <div class="answers">
                    ...
                    <label><input type="radio" name="answer5" class = "respuesta1"> Mario</label><br>
                    <label><input type="radio" name="answer5" class = "respuesta1"> Sonic</label><br>
                    <label><input type="radio" name="answer5" class = "respuesta1"> Capitán Price</label><br>
                </div>
            </div>
            <div class = "question">
