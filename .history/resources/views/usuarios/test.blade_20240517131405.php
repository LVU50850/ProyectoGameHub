    ...
    <div class="quiz-container">
        ...
        <div class="played-questions hidden">
            ...
            <div class="question">
                ...
                <div class="answers">
                    <label><input type="radio" name="answer9" class = "respuesta1"> Gráficos impresionante</label><br>
                    <label><input type="radio" name="answer9" class = "respuesta2"> Mundo abierto con múltiples finales</label><br>
                    <label><input type="radio" name="answer9" class = "respuesta3"> Basada en elecciones del jugador</label><br>
                    <label><input type="radio" name="answer9" class = "respuesta4"> Sin narrativa específica, solo gameplay</label><br>
                </div>
