...
<body>
    <div class="quiz-container">
        ...
        <div class="question" id="has_played_question">
            ...
            <div class="answers">
                <label><input type="radio" name="has_played" value="si" onclick="handleHasPlayedSelection(this)"> Sí</label><br>
                <label><input type="radio" name="has_played" value="no" onclick="handleHasPlayedSelection(this)"> No</label><br>
            </div>
        </div>
