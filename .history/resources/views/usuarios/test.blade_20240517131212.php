    ...
    <div class="quiz-container">
        ...
        <div class="played-questions hidden">
            ...
            <div class="question">
                <p class="question-text">¿Qué plataforma de juego usas más?</p>
                <div class="answers">
                    <label><input type="radio" name="answer8" class = "respuesta1"> Playstation</label><br>
                    <label><input type="radio" name="answer8" class = "respuesta2"> Xbox</label><br>
                    <label><input type="radio" name="answer8" class = "respuesta3"> Nintendo Switch</label><br>
                    <label><input type="radio" name="answer8" class = "respuesta4"> PC</label><br>
                </div>
            </div>
            <div class = "question">
                <button type = "button" onclick = "alClickar()">Siguiente</button>
