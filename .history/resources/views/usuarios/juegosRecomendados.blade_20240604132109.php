...
<head>
    ...
    <title>Videojuegos Recomendados - GameHub</title>
    ...
    <header>
        ...
        <div class="user-profile" onclick="toggleDropdown()">
            ...
            <div class="dropdown-content hidden">
                ...
                <a href="/bienvenida/recomendados/{{$usuario->id}}">
                ...
                <div class="juego">
                    ...
                    <ul>
                        @foreach($juego->comentarios as $comentario)
                            <li><img src="{{ asset('storage/' . $comentario->usuario?->avatar) }}" alt="Perfil" class="profile-icon"><em>{{ $comentario->usuario?->nombre }} - </em>{{ $comentario->texto }}</li>
                        @endforeach
                    </ul>
