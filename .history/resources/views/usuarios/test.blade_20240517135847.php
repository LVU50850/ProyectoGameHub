    ...
    <div class="quiz-container">
        ...
        <div class="not-played-questions hidden">
            ...
            <div class="question">
                <p class="question-text">¿Qué tipo de historias prefieres en los libros o películas?</p>
                <div class="answers">
                    <label><input type="radio" name="answer13" class = "respuesta1"> Historias emocionales y profundas</label><br>
                    <label><input type="radio" name="answer13" class = "respuesta2"> Aventuras llenas de acción y emoción</label><br>
                    <label><input type="radio" name="answer13" class = "respuesta3"> Mundos imaginarios y fantásticos </label><br>
                    <label><input type="radio" name="answer13" class = "respuesta4"> Relatos divertidos y ligeros</label><br>
                </div>
            </div>

            <div class = "question">
                <button type = "button" onclick = "alClickar()">Siguiente</button>
