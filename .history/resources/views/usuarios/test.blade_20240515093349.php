    ...
    <div class="quiz-container">
        ...
        <div class="played-questions hidden">
            ...
            <div class="question">
                ...
                <div class="answers">
                    <label><input type="radio" name="answer4"> Menos de 10</label><br>
            ...
            <div class="question">
                ...
                <div class="answers">
                    <label><input type="radio" name="answer5"> Kratos</label><br>
                    <label><input type="radio" name="answer5"> Acción</label><br>
                    <label><input type="radio" name="answer5"> Historia</label><br>
                    <label><input type="radio" name="answer5"> Online</label><br>
                </div>
            </div>
        </div>
