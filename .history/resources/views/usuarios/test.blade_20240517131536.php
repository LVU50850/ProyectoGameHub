    ...
    <div class="quiz-container">
        ...
        <div class="played-questions hidden">
            ...
            <div class="question">
                ...
                <div class="answers">
                    <label><input type="radio" name="answer9" class = "respuesta1"> DLCs(contenido descargable)</label><br>
                    <label><input type="radio" name="answer9" class = "respuesta2"> Expansiones grandes</label><br>
                    <label><input type="radio" name="answer9" class = "respuesta3"> Actualizaciones gratuitas</label><br>
                    <label><input type="radio" name="answer9" class = "respuesta4"> Mods creados por la comunidad</label><br>
                </div>
            </div>
            <div class = "question">
                <button type = "button" onclick = "alClickar()">Siguiente</button>
