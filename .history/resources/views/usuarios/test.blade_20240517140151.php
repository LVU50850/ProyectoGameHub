    ...
    <div class="quiz-container">
        ...
        <div class="not-played-questions hidden">
            ...
            <div class="question">
                ...
                <div class="answers">
                    <label><input type="radio" name="answer14" class = "respuesta1"> Historias emocionales y profundas</label><br>
                    <label><input type="radio" name="answer14" class = "respuesta2"> Aventuras llenas de acción y emoción</label><br>
                    <label><input type="radio" name="answer14" class = "respuesta3"> Mundos imaginarios y fantásticos </label><br>
                    <label><input type="radio" name="answer14" class = "respuesta4"> Relatos divertidos y ligeros</label><br>
                </div>
            </div>
