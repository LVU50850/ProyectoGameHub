    ...
    <div class="quiz-container">
        ...
        <div class="played-questions hidden">
            ...
            <div class="question">
                ...
                <div class="answers">
                    <label><input type="radio" name="answer7" class = "respuesta1"> Kratos</label><br>
                    <label><input type="radio" name="answer7" class = "respuesta2"> Mario</label><br>
                    <label><input type="radio" name="answer7" class = "respuesta3"> Sonic</label><br>
                    <label><input type="radio" name="answer7" class = "respuesta4"> Capitán Price</label><br>
                </div>
            </div>
            <div class = "question">
                <button type = "button" onclick = "alClickar()">Siguiente</button>
