    ...
    <div class="quiz-container">
        ...
        <div class="played-questions hidden">
            ...
            <div class="question">
                ...
                <div class="answers">
                    <label><input type="radio" name="answer3"> Menos de 10</label><br>
                    <label><input type="radio" name="answer3"> 10-20</label><br>
                    <label><input type="radio" name="answer3"> 20-50</label><br>
                    <label><input type="radio" name="answer3"> Más de 50</label><br>
                </div>
            </div>
