...
Route::get('/bienvenida', [UsuarioController::class, 'index'])->name('index');
...
Route::get('/bienvenida/recomendados/{id}', [TestController::class, 'mostrarRecomendados'])->name('mostrarRecomendados');
