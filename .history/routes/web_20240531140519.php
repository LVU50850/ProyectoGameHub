...
Route::get('/juegos/{usuario_id}', [JuegoController::class, 'verJuegos'])->name('verJuegos');
Route::get('/favoritos/{usuario_id}', [JuegoController::class, 'verFavoritos'])->name('verFavoritos');
Route::get('/recomendados/{usuario_id}', [JuegoController::class, 'verRecomendados'])->name('verRecomendados');
