...
class TestController extends Controller
{
    public function realizarTest($id){
        ...
        if($usuario->recomendados == null){
            return response()->view("usuarios.test",['usuario' => $usuario, "error" => ""]);
        }
        $error = "Ya realizaste el test";
        return response()->view("usuarios.indexTest",['usuario' => $usuario, "error"=>$error]);
    }
