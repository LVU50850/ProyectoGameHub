...
class JuegoController extends Controller
{
    public function guardarJuego(Request $request)
    {
        ...
        $request->validate([
            ...
            'descripcion' => 'required|string|max:255', // Validar que la imagen sea válida
        ]);
        ...
        $juego->descripcion = $request->file('descripcion');// Guardar la ruta de la imagen en la base de datos
        $juego->save();
